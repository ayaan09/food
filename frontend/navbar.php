...
<html lang="en" dir="ltr">
  <head>
    ...
    <img src="logo_new.png" alt="" width="140" height="100">
    ...
    <?php
      ...
      <div class=\"navbar-nav\" style=\"margin-left: 750px !important;\">
        ...
        <a class=\"nav-link\" style=\"color: white !important; padding: 15px !important;\"  href=\"menu.php\">Menu</a>
        <a class=\"nav-link\" style=\"color: white !important; padding: 15px !important;\"  href=\"#\">About Us</a>
        <a class=\"nav-link\" style=\"color: white !important; padding: 15px !important;\"  href=\"orders.php\">$nameNick[0]'s Cart</a>";
        if(isset($_SESSION["username"])){
